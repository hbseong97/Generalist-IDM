...
class TestScreenCaptured:
    ...
    def test_create_from_url_pattern_with_loading(self):
        ...
        test_cases = [
            ...
            (
                "https://huggingface.co/datasets/anonymous/example_dataset/resolve/main/example.mkv",
                1_000_000_000,
                "video",
            ),
    ...
    def test_remote_video_caching_behavior(self):
        ...
        test_url = "https://huggingface.co/datasets/anonymous/example_dataset/resolve/main/example.mkv"
